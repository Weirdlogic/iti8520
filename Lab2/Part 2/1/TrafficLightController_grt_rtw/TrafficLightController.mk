###########################################################################
## Makefile generated for component 'TrafficLightController'. 
## 
## Makefile     : TrafficLightController.mk
## Generated on : Sat Jun 07 11:48:28 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\TrafficLightController.exe
...
COMPILER_COMMAND_FILE     = TrafficLightController_comp.rsp
CMD_FILE                  = TrafficLightController.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\TrafficLightController.exe
...
DEFINES_STANDARD = -DMODEL=TrafficLightController -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\TrafficLightController_grt_rtw\TrafficLightController.c $(START_DIR)\TrafficLightController_grt_rtw\rt_nonfinite.c
...
OBJS = rt_logging.obj TrafficLightController.obj rt_nonfinite.obj
...
{$(START_DIR)\TrafficLightController_grt_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\TrafficLightController_grt_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\TrafficLightController_grt_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\TrafficLightController_grt_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
TrafficLightController.obj : "$(START_DIR)\TrafficLightController_grt_rtw\TrafficLightController.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\TrafficLightController_grt_rtw\TrafficLightController.c"


rt_nonfinite.obj : "$(START_DIR)\TrafficLightController_grt_rtw\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\TrafficLightController_grt_rtw\rt_nonfinite.c"
